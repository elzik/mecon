...
{
    public class PlexOptionsWithCachingTests
    {
        [Fact]
        public void GetService_ForPlexOptions_ReturnsExpectedOptions()
        {
            ...
            var plexOptions = serviceProvider.GetService<IOptions<PlexWithCachingOptions>>();
            ...
            plexOptions?.Value.CacheExpiry.Should().Be(3600);
        }
    }
}
