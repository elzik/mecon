...
[![Coverage](https://gist.github.com/elzik/527882e89a938dc78f61a08c300edec4#file-mecon-code-coverage-main-svg)](https://gist.github.com/elzik/527882e89a938dc78f61a08c300edec4#file-mecon-code-coverage-main-svg)
...
If a directory definition is specified on the command line using the `-n|--directory-definition-name` option, the following commandline options will have no effect since they can already be specified in config as part of the directory definition: `-d -e -r -m -f`.
### Logging
