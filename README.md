...
|-------------------------------------|----------------------------------------|
| "FileSystem": {<br>    "FolderDefinitions": {}<br>        "Films": {<br>            "FolderPath": "\\Video\\Films",<br>            "SupportedFileExtensions": [ "mkv", "ts", "mp4" ],<br>            "MediaTypes": [ "Movie" ]<br>        },<br>        "TV": {<br>            "FolderPath": "\\Video\\TV",<br>            "SupportedFileExtensions": [ "mkv", "ts", "mp4" ],<br>            "MediaTypes": [ "TvShow" ]<br>        }<br>    }<br>} | Mecon__FileSystem__FolderDefinitions__Films__FolderPath=\Video\Films<br>Mecon__FileSystem__FolderDefinitions__Films__SupportedFileExtensions__1=mkv<br>Mecon__FileSystem__FolderDefinitions__Films__SupportedFileExtensions__2=ts<br>Mecon__FileSystem__FolderDefinitions__Films__SupportedFileExtensions__3=mp4<br>Mecon__FileSystem__FolderDefinitions__Films__MediaTypes__1=Movie<br>Mecon__FileSystem__FolderDefinitions__TV__FolderPath=\Video\TV<br>Mecon__FileSystem__FolderDefinitions__TV__SupportedFileExtensions__1=mkv<br>Mecon__FileSystem__FolderDefinitions__TV__SupportedFileExtensions__2=ts<br>Mecon__FileSystem__FolderDefinitions__TV__SupportedFileExtensions__3=mp4<br>Mecon__FileSystem__FolderDefinitions__TV__MediaTypes__1=TvShow<br>|
